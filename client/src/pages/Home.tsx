...
export default function Home() {
  ...
  const purchaseStory = (chapter: number) => {
    ...
    announce(`Página ${chapter} comprada por ${price} Cartas Douradas.`);
  };
